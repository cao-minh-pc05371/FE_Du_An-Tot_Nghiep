...
const ResetPassword = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        let newErrors = {};
        if (!form.password.trim()) newErrors.password = "Vui lòng nhập mật khẩu mới";
        if (!form.confirmPassword.trim()) newErrors.confirmPassword = "Vui lòng xác nhận lại mật khẩu";
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`mt-1 w-full px-4 py-2 border rounded-md text-sm focus:outline-none focus:ring-1 ${errors.confirmPassword ? "border-red-500 ring-red-500" : "focus:ring-red-500"
                                    }`}
                            />
