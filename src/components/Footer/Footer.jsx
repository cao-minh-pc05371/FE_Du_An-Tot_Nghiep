      ...
      <div className="max-w-[1440px] mx-auto px-4 grid grid-cols-1 md:grid-cols-5 gap-8 pb-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/dien-thoai" className="hover:text-white">Điện thoại</Link></li>
            <li><Link to="/laptop" className="hover:text-white">Laptop</Link></li>
            <li><Link to="/phu-kien" className="hover:text-white">Phụ kiện</Link></li>
            <li><Link to="/tivi" className="hover:text-white">Tivi</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/huong-dan-mua-hang" className="hover:text-white">Hướng dẫn mua hàng</Link></li>
            <li><Link to="/tra-cuu-don-hang" className="hover:text-white">Tra cứu đơn hàng</Link></li>
            <li><Link to="/bao-hanh" className="hover:text-white">Chính sách bảo hành</Link></li>
            <li><Link to="/doi-tra" className="hover:text-white">Chính sách đổi trả</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2">
              <FaEnvelope />
              <a href="mailto:support@tekstore.vn" className="hover:text-white">support@tekstore.vn</a>
            </li>
          </ul>
        </div>
      </div>
